...
(
    `category_id`       int(11)                                                NOT NULL AUTO_INCREMENT COMMENT '主键 分类id',
    `category_name`     varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分类名称 分类名称',
    `category_level`    int(11)                                                NOT NULL COMMENT '分类层级 分类的类型，\n1:一级大分类\n2:二级分类\n3:三级分类',
...
(
    ...
    `status`       int(11)                                                 NOT NULL COMMENT '是否展示 1：展示 0：不展示',
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '订单项/快照 '
  ROW_FORMAT = Compact;
...
-- orders 表数据
INSERT INTO `orders`
VALUES ('100001', '1', NULL, '张三', '13030303300', '湖北武汉', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00000000, 0, NULL,
        NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `orders`
VALUES ('100002', '1', NULL, '李四', '13131313311', '湖北宜昌', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00000000, 0, NULL,
        NULL, NULL, NULL, NULL, NULL, NULL);
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '商品 商品信息相关表：分类表，商品图片表，商品规格表，商品参数表'
  ROW_FORMAT = Compact;

-- product 表数据
INSERT INTO `product`
VALUES ('1', '奥利奥小饼干', 46, 2, 196, 1,
...
INSERT INTO `product`
VALUES ('3', '咪咪虾条', 15, 2, 199, 1, '<img src=\"static/pimgs/mmxt_desc.jpg\"/>', '2021-04-26 15:58:09',
        '2021-04-25 15:58:11');
INSERT INTO `product`
...
(
    ...
    `comm_type`     int(11)                                                 NULL DEFAULT NULL COMMENT '评价类型（1：好评，0：中评，-1：差评）',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '商品评价'
  ROW_FORMAT = Compact;

-- product_comments 表数据
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '商品图片'
  ROW_FORMAT = Compact;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '商品参数 '
  ROW_FORMAT = Compact;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '商品规格 每一件商品都有不同的规格，不同的规格又有不同的价格和优惠力度，规格表为此设计'
  ROW_FORMAT = Compact;

-- product_sku 表数据
INSERT INTO `product_sku`
VALUES ('1', '3', '咪咪虾条 单包 50g', 'mmxt_1.png', '{口味:[\"原味\",\"烧烤\",\"芥末\"],包装:[\"盒装\",\"袋装\"]}', 2, 1, 0.70, 333,
        '2021-04-26 15:58:00', '2021-04-25 15:58:00', 1);
INSERT INTO `product_sku`
VALUES ('2', '3', '咪咪虾条 6连包', 'mmxt_1.png', '{口味:[\"原味\",\"烧烤\"],包装:[\"新包装\",\"老包装\"]}', 6, 5, 0.60, 199,
        '2021-04-26 14:48:21', '2021-04-26 14:48:25', 1);
INSERT INTO `product_sku`
VALUES ('3', '3', '咪咪虾条 整箱50包', 'mmxt_1.png', '{口味:[\"原味\",\"烧烤\",\"孜然\"]}', 50, 40, 0.50, 50, '2021-04-26 14:49:20',
        '2021-04-26 14:49:23', 1);
INSERT INTO `product_sku`
VALUES ('4', '1', '奥利奥分享装', 'ala_1.png', '{口味:[\"草莓\",\"巧克力\",\"牛奶\",\"原味\"]}', 10, 8, 0.80, 167, '2021-04-27 11:38:55',
...
VALUES (1, '3', '3', '1', '2', '2021-04-29 02:21:43', 40.00000000, '口味:烧烤');
INSERT INTO `shopping_cart`
VALUES (8, '1', '4', '1', '2', '2021-04-29 02:21:43', 8.00000000, '口味:草莓;');
INSERT INTO `shopping_cart`
VALUES (9, '1', '4', '6', '3', '2021-04-29 02:24:50', 8.00000000, '口味:草莓;');
INSERT INTO `shopping_cart`
VALUES (10, '3', '2', '1', '19', '2021-04-29 03:23:57', 5.00000000, '口味:烧烤;包装:老包装;');
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '用户地址'
  ROW_FORMAT = Compact;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '登录历史表'
  ROW_FORMAT = Compact;
